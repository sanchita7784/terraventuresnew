...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">My Transaction Summary</h4>
        <p class="card-title-desc">
            <div class="d-flex justify-content-between">
                <form style="width : 80%">
                    <input type="hidden" name="r" value="transaction/my_summary" />
                    <div class="row">
                        ...
                        <div class="col-md-3 col-xl-2">
                            ...
                            <a href="<?= url_without_query_params("transaction/my_summary") ?>" class="btn btn-secondary">Clear</a>
                        </div>
                    </div>
                </form>
                <div>
