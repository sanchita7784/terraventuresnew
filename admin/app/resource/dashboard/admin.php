...
$total_transaction = $transaction->findCount(null);
$pending_transaction = $transaction->findCount(Condition::init("AND")->add("status", "pending"));
$complete_transaction = $transaction->findCount(Condition::init("AND")->add("status", "COMPLETED"));
$failed_transaction = $transaction->findCount(Condition::init("AND")->add("status", "FAILED"));
